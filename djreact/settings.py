...
SECRET_KEY = 'abk-an-m*64sb2l@#@3*%h-g#pwkqkygn(aa%xf%-+bh^waz!q'
...
STATIC_URL = 'djreact/static/'
STATIC_ROOT = '%sstatic/' % BASE_DIR
MEDIA_ROOT = os.path.join(BASE_DIR, "djreact/static/media")
MEDIA_URL = 'djreact/static/media/'
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, "djreact/static"),
    os.path.join(BASE_DIR, "djreact/static/media"),)
